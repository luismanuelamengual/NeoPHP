...
class BladeViewFactory extends ViewFactory {
    ...
    public function __construct(array $config = []) {
        ...
        $compiledTemplatesPath = isset($config["compiledTemplatesPath"]) ? $config["compiledTemplatesPath"] : app()->getStoragePath() . DIRECTORY_SEPARATOR . "framework" . DIRECTORY_SEPARATOR . "views";
